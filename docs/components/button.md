...
完整参数见源码 [`Button.kt`](https://github.com/CTOO-UXD/Android-GeneV4/blob/main/library/src/commonMain/kotlin/com/genev4/Button.kt)。常用：`onClick`、`enabled`、`colors`、`contentPadding`、`content`。
